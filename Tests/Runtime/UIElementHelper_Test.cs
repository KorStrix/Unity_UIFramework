...
namespace StrixLibrary_Test
{
    ...
    public class HasButton_TestObject : MonoBehaviour, IHas_UIButton<HasButton_TestObject.EButtonObjectName>
    {
        ...
        public void IHas_UIButton_OnClickButton(EButtonObjectName eButtonName, Button pButton)
        {
    ...
    public class HasToggle_TestObject : MonoBehaviour, IHas_UIToggle<HasToggle_TestObject.EToggleObjectName>
    {
        ...
        public void IHas_UIToggle_OnToggle(EToggleObjectName eToggleName, Toggle pToggle, bool bToggle)
        {
            eLastClickToggle = eToggleName;
            bLastToggle = bToggle;
        }
    }

    [Category("StrixLibrary")]
    public class UIElementHelper_Test : MonoBehaviour
    {
        [Test]
        static public void HasButton_Test()
        {
            ...
            // Helper를 통한 Init
            SCUIElementHelper.DoInit_HasUIElement(pTestScript);
