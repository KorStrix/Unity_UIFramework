...
{
    void IScrollItem_Update(int iIndex);
}

[DisallowMultipleComponent]
[RequireComponent(typeof(RectMask2D))]
[RequireComponent(typeof(RectTransform))]
public class CUGUIScrollView : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
{
    ...
    public delegate void del_UpdateScrollItem(GameObject pObjectScrollItem, int iIndex);
    public event del_UpdateScrollItem OnUpdateScrollItem;
    ...
    public void DoUpdateScroll(int iScrollItemCount)
    {
        DoAwake();
    ...
    {
        pScrollObject.SendMessage("IScrollItem_Update", iIndex, SendMessageOptions.DontRequireReceiver);
        OnUpdateScrollItem?.Invoke(pScrollObject, iIndex);
    }

    public void DoAllClear_OnUpdateScrollItemEvent()
    {
        OnUpdateScrollItem = null;
    }
